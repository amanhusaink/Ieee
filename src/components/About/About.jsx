...
function About() {
  ...
  <div className="flex-1 ">
    <div className=''>
    <h1 className='text-slate-400 text-lg   sm-head '>About Our Company</h1>
    ...
    Established in 2005, IEEE SB AWHEC has been a pioneer in promoting  technical innovation and professional development among students at  AWHEC.
     ...
     delve into advanced  technologies, and contribute to the global IEEE network.
      Over the years,  we have become a center of creativity and collaboration,
       offering  numerous opportunities for students to participate in technical  projects, workshops, and competitions.
    In 2024, we reached a significant milestone by earning a spot on the  esteemed IEEE LINK team, reflecting the dedication and hard work of our  members. 
    As we continue to grow, we remain dedicated to equipping our  members with the knowledge,
     skills, and connections necessary to excel  in their careers and positively impact society.
    </p>
    </div>
  </div>
  </div>
